   ...
   .on("mousemove touchmove",updateTooltip)
    ...
    function updateTooltip(){
      ...
      var dataType = d3.select('input:checked')
                        .property("value")
      var units  = dataType ==="emissions"?"thousand metric tonnes" : "metric tonnes per capita";
      var data ;
      var percentage='';
